...
function linkAudio(){
   ...
   pegaDias();
   if(horaAtual == iniciotr || diasMarcados.includes(diaSemana) == true){
...
function opcaoLink(){
   ...
   <div id="link">
    ...
    <center><audio controls id="audio" type="application/x-mpegURL"></audio></center>
       ...
       <div>
       <center><button type="button" onclick="agendarLink(), obterMarcados();" class="btn btn-primary btn-sm">Agendar</button></center>
